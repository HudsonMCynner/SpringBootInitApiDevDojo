...
public class StudentEndpointTest {
    ...
    public void getStudentsByIdWhenUsernameAndPasswordAreCorrectShouldReturnStatusCode200() {
        ResponseEntity<Student> response = restTemplate.getForEntity("/v1/protected/students/{id}", Student.class, 2L);
        Assertions.assertThat(response.getStatusCodeValue()).isEqualTo(200);
    }
    ...
    public void deleteWhenUserHasRoleAdminAndStudentDoesExistsShouldReturnStatusCode404() throws Exception {
        BDDMockito.doNothing().when(studentRepository).delete(1L);
//        ResponseEntity<String> exchange = restTemplate.exchange("/v1/admin/students/{id}", DELETE, null, String.class, -11L);
...
//        Assertions.assertThat(exchange.getStatusCodeValue()).isEqualTo(404);
    ...
    @Test
    public void createWhenNameIsnullShouldReturnStatusCode400BasdRequest () throws Exception {
        Student student = new Student(7L, null, "sam@gmail.com");
    ...
    public void createShouldPersistDataAndReturnStatusCode201 () throws Exception {
        Student student = new Student(3L, "Sam", "sam@gmail.com");
        BDDMockito.when(studentRepository.save(student)).thenReturn(student);
